...
- LM-Nexus — AI-tools for self hosting  (privae for now)
  A local AI control center with a Python FastAPI backend and a Vue.js frontend. Designed to manage llama.cpp / Llama-swap, Docker and Edge apps for running models locally. Tech mix: Python, Vue, CSS, JavaScript, PowerShell, TypeScript.
...
- The-Settlers-7-CPU-Optimizer — Game performance utility  (legacy)
  Python utility that adjusts process affinity and priority for The Settlers 7 to improve framerate (by disabling hyperthreading affinity for the process). Gives a noticeable FPS boost without changing graphics. Languages: Python + small HTML docs.
